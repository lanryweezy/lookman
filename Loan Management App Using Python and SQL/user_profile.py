...
@user_profile_bp.route('/dashboard')
@login_required
def profile_dashboard():
    """Main profile management dashboard"""
    return render_template('user_profile.html')

@user_profile_bp.route('/current', methods=['GET'])
@login_required
...
@user_profile_bp.route('/update', methods=['POST', 'PUT'])
@login_required
def update_profile():
...
@user_profile_bp.route('/admin/users', methods=['GET'])
@login_required
@admin_required
def get_all_users():
...
@user_profile_bp.route('/admin/user/<int:user_id>', methods=['GET'])
@login_required
@admin_required
...
@user_profile_bp.route('/admin/user/<int:user_id>/update', methods=['POST', 'PUT'])
@login_required
@admin_required
...
@user_profile_bp.route('/admin/user/<int:user_id>/reset-password', methods=['POST'])
@login_required
@admin_required
...
@user_profile_bp.route('/admin/user/create', methods=['POST'])
@login_required
@admin_required
...
@user_profile_bp.route('/admin/user/<int:user_id>/toggle-status', methods=['POST'])
@login_required
@admin_required
...
@user_profile_bp.route('/check-first-login', methods=['GET'])
@login_required
...
@user_profile_bp.route('/profile-stats', methods=['GET'])
@login_required
